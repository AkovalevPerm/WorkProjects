...
namespace Iis.Eais.GosUslugi
{
    ...
    [BusinessServer("Iis.Eais.GosUslugi.RodstvOtnBS, Eais.GosUslugi.BusinessServers", ICSSoft.STORMNET.Business.DataServiceObjectEvents.OnAllEvents)]
    [AutoAltered()]
    [AccessType(ICSSoft.STORMNET.AccessType.@this)]
    [View("AuditView", new string[0])]
    [View("RodstvOtnE", new string[0])]
    [View("RodstvOtnL", new string[0])]
    public class RodstvOtn : ICSSoft.STORMNET.DataObject, IDataObjectWithAuditFields
    {
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View AuditView
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("AuditView", typeof(Iis.Eais.GosUslugi.RodstvOtn));
                }
            }
            ...
            public static ICSSoft.STORMNET.View RodstvOtnE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("RodstvOtnE", typeof(Iis.Eais.GosUslugi.RodstvOtn));
                }
            }
            ...
            public static ICSSoft.STORMNET.View RodstvOtnL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("RodstvOtnL", typeof(Iis.Eais.GosUslugi.RodstvOtn));
                }
            }
        }
